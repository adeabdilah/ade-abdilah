...
<body background="img/bg/bck.png">
               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              ...
                              <input type="number" class="form-control w-50" id="nis" placeholder="Masukkan NIM" min="1"
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-person-plus-fill"></i>Tambah Data Mahasiswa Kronjo'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
